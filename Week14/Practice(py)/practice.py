...
def initial_data_pull(coins):
    ...
    for coin in coins:
        file = open("/home/ubuntu/environment/Week14/Data_2/" + coin + ".csv", "w")
...
def append_data(coins):
    ...
    for coin in coins:
        ...
        file = open("/home/ubuntu/environment/Week14/Data_2/" + coin + ".csv", "r")
        # one in read mode
        # reading the lines
        ...
        csv_file = open("/home/ubuntu/environment/Week14/Data_2/" + coin + ".csv", "a")
...
def SaveResults(results):
    with open(f"./Week14/Practice(py)/results.json", "w") as f:
        json.dump(results, f)
...
for coin in coins:
    ...
    with open(f"./Week14/Data_2/{coin}.csv", "r") as f:
        lines = f.readlines()
